---
title: Print Plugin
description: Enables high-quality printing of PDF documents by leveraging the browser's native print dialog.
searchable: true
---
...
import { PDFViewer } from '../code-examples/print-example';
